...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/aniket-chelawat/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@aniket_.chelawat",
    icon: Instagram,
    url: "https://www.instagram.com/aniket_.chelawat?igsh=MXJuZDFxbmF4ZHlzMQ=",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@aniketchelawat27",
    icon: Github,
    url: "https://github.com/aniketchelawat27",
    color: "#ffffff",
